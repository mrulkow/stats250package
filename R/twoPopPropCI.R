...
#' Confidence Interval for a Difference in Two Population Proportions Function
#'
#' This function creates a confidence interval for a difference in two population proportions.
#' 
