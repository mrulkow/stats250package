...
#' Hypothesis Test for a Difference in Two Population Proportions Function
#'
#' This function runs a hypothesis test for a difference in two population proportions.
#' 
...
#' twoPopPropHT(x1 = 47, n1 = 112, x2 = 39, n2 = 102, alt = "greater")
